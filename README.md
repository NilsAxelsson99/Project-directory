...
This project focuses on organizing and version-controlling a simulation framework i have developed in Matlab for testing multi-agent formation control algorithms. The goal is to migrate a messy local library of scripts (which together simulate the movement of agents) into a GitHub repository to ensure research reproducibility and historical tracking.
